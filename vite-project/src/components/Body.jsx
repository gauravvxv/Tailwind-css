    ...
    return (
        <div className='space-y-4 '>
            <div className='flex items-center justify-center'>
                <img src="./assets/Blue-Shape.svg" alt="Image" className='-rotate-45 h-64 md:h-72' />
                <img src="./assets/Pink-Shape.svg" alt="Image" className='absolute -rotate-[30deg] h-64 md:h-72' />
                <img src="./assets/Purple-Shape.svg" alt="Image" className='absolute -rotate-[15deg] h-64 md:h-72' />
                <img src="./assets/Hero-Model.png" alt="Image" className='absolute h-64' />
            </div>
